# <center>CipherTools</center>


### CipherTools 简介

> 这是一个在 Yumeyo开发的 NetInfoChecker 网络综合查询器（e语言版）为灵感的，基于其功能与Qt6开发的集网络信息、WOL唤醒、NAT（网络地址转换等级）检测、游戏IP和全球网测延迟检测、路由跟踪为一身的超级工具<br>

## 预览截图

![Screenshot](images/sc.png)<br>
